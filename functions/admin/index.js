...
<style>
  ...
  input{
    padding:.5rem .75rem;background:#fff;color:#000;border:1px solid #ccc;border-radius:.25rem;outline:none;width:260px;
  }
...
<div class="card" id="loginCard">
  <div class="row"><label for="u">Username</label><input id="u" autocomplete="username"></div>
  <div class="row"><label for="p">Password</label><input id="p" type="password" autocomplete="current-password"></div>
  <div class="btns"><button type="button" id="loginBtn">Login</button></div>
</div>
...
<div class="card" id="adminCard" style="display:none">
  ...
  <div class="btns">
    ...
    <button type="button" id="btnCancel" class="danger" disabled>Cancel</button>
    <button type="button" class="muted" id="btnClear">Clear</button>
  </div>
  <div id="result"></div>
  <pre id="logs"></pre>
</div>
...
<div class="card" id="schedCard" style="display:none">
  <h3>Schedule (UTC)</h3>
  <div class="row"><label for="hour">Hour (0-23)</label><input id="hour" type="number" min="0" max="23" value="7"></div>
  <div class="row"><label for="minute">Minute (0-59)</label><input id="minute" type="number" min="0" max="59" value="0"></div>
  <div class="row"><label for="enabled">Enabled</label><input id="enabled" type="checkbox" checked></div>
  <div class="btns"><button type="button" id="saveSchedule">Save Schedule</button></div>
  <div class="row"><small>America/Detroit ≈ UTC‑4 / UTC‑5.</small></div>
</div>
